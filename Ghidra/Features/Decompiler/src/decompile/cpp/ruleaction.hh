...
public:
  RuleAndZext(const std::string &g) : Rule(g, 0, "andzext") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleStackAlignFix(const std::string &g) : Rule(g, 0, "stackalignfix") {} ///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *) 0;
...
public:
  RuleLzcountShiftBool(const std::string &g) : Rule( g, 0, "lzcountshiftbool") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleLzcntZeroTest(const std::string &g) : Rule( g, 0, "lzcntzerotest") {}  ///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
